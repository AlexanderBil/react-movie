...
class Movie extends React.Component{
  ...
  render(){
    ...
    return(
      <div  id={imdbID} className="card movie modal-trigger" href="#modal1">
      <a   >
        <div onClick = {this.searchMoviesPop}  className="card-image waves-effect waves-block waves-light">
          {Poster === "N/A" ? (
            <img
              className="activator"
